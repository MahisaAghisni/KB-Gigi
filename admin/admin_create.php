...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO login (id_login, username, password) VALUES (%s, %s, %s)",
...
$query_rsAdminCreate = sprintf("SELECT * FROM login WHERE id_login = %s", GetSQLValueString($colname_rsAdminCreate, "int"));
$rsAdminCreate = mysqli_query($koneksi, $query_rsAdminCreate) or die(mysql_error());
$row_rsAdminCreate = mysqli_fetch_assoc($rsAdminCreate);
$totalRows_rsAdminCreate = mysqli_num_rows($rsAdminCreate);
?>
...
<div class="w3-container w3-light-gray">
  ...
  <li style="border-bottom:1px solid #DDD;"><i class="fa fa-times fa-fw"></i> Keluar</li>
                    ...
                    <div class="w3-col l9" style="padding-left:8px;">
                    	<div class="w3-border w3-padding"><!-- InstanceBeginEditable name="EditRegion2" --><div class="w3-border-bottom" style="padding-bottom:10px; margin-top:8px;"><strong><i class="fa fa-plus"></i> TAMBAH DATA LOGIN</strong></div>
...
<input type="password" class="w3-input w3-border w3-small" required name="password" value="" size="32">
  ...
  <table align="center" style="display:none">
    <tr valign="baseline">
      ...
      <td><input type="hidden" name="id_login" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
...
<?php
mysqli_free_result($rsAdminCreate);
?>
