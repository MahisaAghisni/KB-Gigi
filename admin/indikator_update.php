...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE indikator SET nama_indikator=%s, nilai=%s WHERE id_indikator=%s",
...
$colname_rsIndikatorUpdate = "-1";
if (isset($_GET['id_indikator'])) {
  $colname_rsIndikatorUpdate = $_GET['id_indikator'];
}

$query_rsIndikatorUpdate = sprintf("SELECT * FROM indikator WHERE id_indikator = %s", GetSQLValueString($colname_rsIndikatorUpdate, "int"));
$rsIndikatorUpdate = mysqli_query($koneksi, $query_rsIndikatorUpdate) or die(mysqli_error());
$row_rsIndikatorUpdate = mysqli_fetch_assoc($rsIndikatorUpdate);
$totalRows_rsIndikatorUpdate = mysqli_num_rows($rsIndikatorUpdate);
?>
...
<div class="w3-container w3-light-gray">
  ...
  <li style="border-bottom:1px solid #DDD;"><i class="fa fa-times fa-fw"></i> Keluar</li>
                    ...
                    <div class="w3-col l9" style="padding-left:8px;">
                    	<div class="w3-border w3-padding"><!-- InstanceBeginEditable name="EditRegion2" --><div class="w3-border-bottom" style="padding-bottom:10px; margin-top:8px;"><strong><i class="fa fa-edit"></i> UBAH INDIKATOR BOBOT</strong></div>
                        
                     
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
<div style="margin-top:8px">
<label>Nama Indikator</label>
<input class="w3-input w3-border w3-small" required type="text" name="nama_indikator" value="<?php echo htmlentities($row_rsIndikatorUpdate['nama_indikator'], ENT_COMPAT, ''); ?>" size="32">
</div>

<div style="margin-top:8px">
<label>Nilai Bobot</label>
<input class="w3-input w3-border w3-small" required type="text" name="nilai" value="<?php echo htmlentities($row_rsIndikatorUpdate['nilai'], ENT_COMPAT, ''); ?>" size="32">
</div>
  ...
  <input type="hidden" name="id_indikator" value="<?php echo $row_rsIndikatorUpdate['id_indikator']; ?>">
  <input type="hidden" name="MM_update" value="form1">
  <input type="hidden" name="id_indikator" value="<?php echo $row_rsIndikatorUpdate['id_indikator']; ?>">
</form>
<br>
<?php
mysqli_free_result($rsIndikatorUpdate);
?>
